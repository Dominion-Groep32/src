...
public class SpelEngine {
    ...
    public void brengAlleKaartenNaarAflegstapel(){
        ...
        for (int i = 0; i < lijstAlleSpelers.size(); i++) {
            ...
            speler.maakAlleSpecialeLijstenLeeg();
        }
    }
    ...
    private void spion(ExtraInfo kaartMetExtraInfo){
        for (int i = 0; i < kaartMetExtraInfo.geefSpelers().size(); i++) {
            ...
            if(speler.geefKeuzeSpeler()){
                brengEenKaartVanDeEneNaarAndereStapel(speler.geefTrekStapel(), speler.geefTrekStapel().get(0),speler.geefAflegStapel() );
            }}}
	...
	public void zetAantalGekozenKaarten(int geefMaxAantalKaarten) {
		// TODO Auto-generated method stub
		
	}

	public Kaart krijgHuidigeKaart() {
		return this.huidigeKaart;
	}

	public void zetHuidigeKaart(Kaart huidigeKaart) {
		this.huidigeKaart = huidigeKaart;
	}

	public int AantalGekozenKaarten() {
	
		return this.AantalGekozenKaarten;
	}

	public int krijgAantalGekozenKaarten() {
		return AantalGekozenKaarten;
	}
}