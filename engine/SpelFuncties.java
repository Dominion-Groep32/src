...
public class SpelFuncties {
    ...
    */
	...
	public int geefAantalGekozenKaarten() {
		return aantalGekozenKaarten;
	}

	public void zetAantalGekozenKaarten(int aantalGekozenKaarten) {
		this.aantalGekozenKaarten = aantalGekozenKaarten;
	}
}